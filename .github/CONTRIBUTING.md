...
- For anything non-trivial, [open an issue](https://github.com/SDSLeon/craftstation/issues/new/choose) first so we can align on scope.
- Search [existing issues](https://github.com/SDSLeon/craftstation/issues) and [PRs](https://github.com/SDSLeon/craftstation/pulls) to avoid duplicates.
...
```bash
git clone https://github.com/<your-username>/craftstation.git
cd craftstation
pnpm install
pnpm run dev
```
...
Use the [issue templates](https://github.com/SDSLeon/craftstation/issues/new/choose). Include OS, CraftStation version, the agent(s) involved, and reproduction steps.
