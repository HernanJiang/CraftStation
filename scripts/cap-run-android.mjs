...
//   1. $CRAFTSTATION_ANDROID_TARGET      - explicit override (device serial or AVD id)
...
function resolveTarget() {
  const override = process.env.CRAFTSTATION_ANDROID_TARGET?.trim();
...
if (process.env.CRAFTSTATION_CAP_DRY_RUN) {
