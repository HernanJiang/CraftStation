...
Pod::Spec.new do |s|
  s.name = 'CraftStationActivityBridge'
  s.version = package['version']
  s.summary = package['description']
  s.license = package['license']
  s.homepage = 'https://github.com/SDSLeon/craftstation'
  s.author = package['author']
  s.source = { :git => 'https://github.com/SDSLeon/craftstation.git', :tag => s.version.to_s }
