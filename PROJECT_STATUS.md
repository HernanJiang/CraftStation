...
- 已提交 `f8186f7` 并 push，tag `v1.2.13` 已打并推送；NSIS 安装包 `release/CraftStation-Setup-1.2.13-x64.exe`（+ blockmap/latest.yml）已打出；GitHub Release v1.2.13 已发布为 Latest（含安装包/blockmap/latest.yml，updater 可用）。
