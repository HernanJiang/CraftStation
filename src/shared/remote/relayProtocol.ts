 ...
 * 5). A CraftStation server behind NAT dials OUT to a relay and registers under a
 ...
 */
export const CRAFTSTATION_RELAY_PROTOCOL_VERSION = 1;
...
export const relayRegisterFrameSchema = z.object({
  ...
  protocolVersion: z.literal(CRAFTSTATION_RELAY_PROTOCOL_VERSION),
