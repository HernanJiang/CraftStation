...
// collaboration exchange or discard its deterministic anchors. It retains all
// v4 project icon and GitHub account fields from the previous protocol version.
