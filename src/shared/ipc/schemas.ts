...
export const readLocalImageFilePayloadSchema = z.object({
  url: z.string().regex(/^(?:craftstation|craftstation)-local:\/\//),
});
...
export const craftAgentPayloadSchema = z.object({
...
export const craftAgentResultSchema = z.object({
  threadId: z.string().min(1),
...
export const resumeCraftAgentPayloadSchema = z.object({
  craftPlan: craftPlanSchema,
  projectLocation: projectLocationSchema,
