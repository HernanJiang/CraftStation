...
import {
  ...
  craftAgentPayloadSchema,
  type CraftAgentPayload,
  type CraftAgentResult,
  resumeCraftAgentPayloadSchema,
  type ResumeCraftAgentPayload,
...
export const threadProcedures = {
  ...
  craftAgent: definePayloadProcedure<CraftAgentPayload, CraftAgentResult, "supervisor">(
    "craftAgent",
    "supervisor",
    craftAgentPayloadSchema,
  ),
  resumeCraftAgent: definePayloadProcedure<ResumeCraftAgentPayload, CraftAgentResult, "supervisor">(
    "resumeCraftAgent",
    "supervisor",
    resumeCraftAgentPayloadSchema,
  ),
