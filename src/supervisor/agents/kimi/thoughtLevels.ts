...
/**
 * Reduce a probed thought-level list to the levels CraftStation should offer.
 *
 ...
 * levels at all, is what lets CraftStation put an untiered model back into its only
