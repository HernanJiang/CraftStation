 ...
 * node_repl. Its mandatory skill conflicts with CraftStation's separate `browser`
 * MCP and makes Codex reject the working CraftStation tools. Disable that one
