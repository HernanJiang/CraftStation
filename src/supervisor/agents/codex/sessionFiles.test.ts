...
describe("parseCodexRolloutMeta", () => {
  it("parses originator and source from a rollout session_meta line", () => {
    const result = parseCodexRolloutMeta(
      ...
      '{"timestamp":"2026-04-06T02:22:34.368Z","type":"session_meta","payload":{"id":"019d6099-45a3-7962-a595-2d7f59276118","cwd":"C:\\\\Users\\\\sdsle\\\\work\\\\craftstation","originator":"codex-tui","source":"cli"}}',
      123,
    );
    ...
    expect(result).toEqual({
      ...
      updatedAt: 123,
      cwd: "C:\\Users\\sdsle\\work\\craftstation",
