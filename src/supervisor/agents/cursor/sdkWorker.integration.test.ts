...
async function createHarness(): Promise<{
  ...
  const directory = mkdtempSync(join(tmpdir(), "craftstation-cursor-sdk-worker-"));
  ...
  const configuredWorkerPath = process.env.CRAFTSTATION_CURSOR_SDK_WORKER_TEST_PATH;
