...
export function createSupervisorIpcHandlers(runtime: SupervisorRuntime): SupervisorIpcHandlerMap {
  ...
  return defineSupervisorIpcHandlers({
    ...
    selectAccount: (payload) => runtime.selectAccount(payload.accountId),
    setAccountEnabled: (payload) => runtime.setAccountEnabled(payload.accountId, payload.enabled),
    renameAccount: (payload) => runtime.renameAccount(payload),
    reorderAccounts: (payload) =>
      runtime.reorderAccounts(payload.provider, payload.orderedAccountIds),
    resolveAccount: (payload) => runtime.resolveAccount(payload),
    setAccountPoolScheduling: (payload) => runtime.setAccountPoolScheduling(payload),
    getAccountPoolScheduling: (payload) => runtime.getAccountPoolScheduling(payload),
    getTokenUsage: (payload) => runtime.getTokenUsage(payload),
    getTokenUsageCapabilities: () => runtime.getTokenUsageCapabilities(),
    refreshTokenUsage: (payload) => runtime.getTokenUsage(payload),
    createCodexProfile: (payload) => runtime.createCodexProfile(payload),
    importCodexProfile: (payload) => runtime.importCodexProfile(payload),
    startCodexProfileLogin: (payload) => runtime.startCodexProfileLogin(payload),
    createKimiProfile: (payload) => runtime.createKimiProfile(payload),
    importKimiProfile: (payload) => runtime.importKimiProfile(payload),
    importKimiApiKey: (payload) => runtime.importKimiApiKey(payload),
    startKimiProfileLogin: (payload) => runtime.startKimiProfileLogin(payload),
    completeKimiProfileLogin: (payload) => runtime.completeKimiProfileLogin(payload.accountId),
    createGrokProfileLogin: (payload) => runtime.createGrokProfileLogin(payload),
    startGrokProfileLogin: (payload) => runtime.startGrokProfileLogin(payload),
    completeGrokProfileLogin: (payload) => runtime.completeGrokProfileLogin(payload),
    ...
    installCompatibilityBridge: () => runtime.installCompatibilityBridge(),
    ensureCompatibilityBridge: () => runtime.ensureCompatibilityBridge(),
    ...
    requestSessionSwitch: (payload) => runtime.requestSessionSwitch(payload),
    cancelSessionSwitch: (payload) =>
      runtime.cancelSessionSwitch(payload.threadId, payload.requestId),
    readSessionSwitchState: (payload) => runtime.readSessionSwitchState(payload.threadId),
