...
//   ...(KHTML, like Gecko) CraftStation/1.3.2 Chrome/146.0.0.0 Electron/41.7.0 Safari/537.36
...
// the host app's own product token (`CraftStation/1.3.2`) to make the UA look like
