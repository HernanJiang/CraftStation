...
describe("SidebarFooterNav", () => {
  ...
  it("shows labeled rows with a collapse toggle by default", () => {
    ...
    // v0.2.6: shortcut destinations (Pull requests / Schedules / Work) moved to
    // the Codex-style top nav (SidebarCodexNav); the expanded footer keeps
    // settings and panel controls only. They remain reachable in the collapsed
    // icon rail, covered by the toggle test below.
