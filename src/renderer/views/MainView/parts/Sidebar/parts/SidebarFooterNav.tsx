...
export function SidebarFooterNav(props: { remoteAccessStatus: RemoteAccessSidebarStatus }) {
          ...
          {needsOverflow && overflowedActions.length > 0 ? (
            ...
            >
              ...
              <Dropdown.Popover placement="top end">
                <Dropdown.Menu
                  aria-label={t`More`}
                  className="craftstation-menu min-w-48"
                  onAction={(key) => {
  ...
  return (
    <div className={sidebarFooterNavClass}>
      ...
      <UpdateButtons />
      <WhatsNewButton />
      {/* v0.2.6: shortcut destinations (pull requests / schedules / actions)
          moved to the Codex-style top nav (SidebarCodexNav); the footer keeps
          workspace, updates, settings, and panel controls only. */}
