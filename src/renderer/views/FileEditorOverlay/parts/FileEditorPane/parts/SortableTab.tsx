...
export function SortableTab(props: {
  ...
  return (
    <div
      ...
      className={`craftstation-content-over-drag-region group flex h-6 max-w-[220px] shrink-0 cursor-default items-center gap-1 rounded-md pl-3 pr-1 text-xs transition-colors ${
        isActive
