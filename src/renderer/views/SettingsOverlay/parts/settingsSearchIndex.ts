...
export const SETTINGS_SEARCH_INDEX: readonly SettingsSearchEntry[] = [
  // General
  {
    ...
    title: msg`Language`,
    description: msg`Choose the display language for CraftStation's interface.`,
  ...
  },
  {
    ...
    description: msg`When you close the window, keep CraftStation running in the system tray. Disable to quit on close.`,
  ...
  },
  {
    ...
    description: msg`Launch CraftStation automatically when you sign in to Windows.`,
  ...
  },
  {
    ...
    description: msg`Keep CraftStation in the system tray when it launches at startup.`,
  ...
  },
  {
    ...
    title: msg`Theme`,
    description: msg`Popular editor themes adapted to CraftStation. Each follows the light or dark mode above.`,
  ...
  },
  {
    ...
    description: msg`Used for agents, authentication, installs, and CraftStation's internal commands.`,
    keywords:
  ...
  },
  {
    ...
    description: msg`Worktree threads are marked done as soon as CraftStation sees their pull request merge. Threads mid-turn wait until the turn finishes.`,
  ...
  },
  {
    ...
    description: msg`Choose what CraftStation does for new pull requests: nothing, fix merge blockers, or fix and merge.`,
  ...
  },
  {
    ...
    description: msg`Choose how CraftStation performs manual merges and automatic PR merges.`,
  ...
  // Worktrees
  {
    ...
    description: msg`Use one global folder, or nest worktrees inside each project at .craftstation/worktrees.`,
  ...
  // MCP Servers
  {
    ...
    description: msg`Manage the MCP server configurations CraftStation adds when starting supported agents. Workspace servers can be configured in each project's settings.`,
    keywords:
  ...
  // Browser
  {
    ...
    description: msg`Choose whether links from CraftStation and browser popups stay in CraftStation or open externally.`,
  ...
  },
  {
    ...
    description: msg`When links open in a CraftStation browser tab, choose where the browser is revealed.`,
