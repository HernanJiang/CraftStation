...
export const NATIVE_AGENT_REGISTRY_ENTRIES: NativeAgentRegistryEntry[] = [
  {
    ...
    description: msg`First-class Codex CLI integration using CraftStation's native app-server runtime.`,
  ...
  },
  {
    ...
    description: msg`First-class Claude Code integration using CraftStation's native SDK runtime.`,
  ...
  },
  {
    ...
    description: msg`First-class OpenCode integration using CraftStation's native SDK runtime.`,
  ...
  {
    id: "kimi",
    description: msg`First-class Kimi Code CLI integration using CraftStation's native runtime.`,
  ...
  {
    id: "antigravity",
    description: msg`First-class Antigravity CLI integration using CraftStation's native runtime.`,
  ...
  {
    id: "commandcode",
    description: msg`First-class Command Code CLI integration using CraftStation's native runtime.`,
  ...
  },
  {
    ...
    description: msg`First-class Gemini CLI integration using CraftStation's native runtime.`,
  ...
  {
    id: "qwen",
    description: msg`First-class Qwen Code integration using CraftStation's native terminal and ACP runtimes.`,
  ...
  },
  {
    ...
    description: msg`First-class Qoder CLI integration using CraftStation's native terminal and ACP runtimes.`,
  ...
  },
  {
    ...
    description: msg`First-class GitHub Copilot CLI integration using CraftStation's native runtime.`,
    docsUrl:
