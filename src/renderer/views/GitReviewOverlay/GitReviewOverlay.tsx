  ...
  return (
    <PageLayout
      ...
      contentHeaderChildren={
        <>
          <div className="craftstation-overlay-header__controls flex min-w-0 shrink items-center gap-2 pl-1.5">
          ...
          {selectedFile && (
            <div className="craftstation-overlay-header__controls flex items-center gap-3">
              <button
                type="button"
          ...
          <div className="craftstation-overlay-header__controls flex items-center gap-1">
            <button
              type="button"
