...
export const NON_ROUTER_PROJECT_PROCEDURES = {
  ...
  switchThreadProvider: "handoff-is-local-supervisor-only",
  ...
  getSchedule: "device-owned-control",
  ...
  pauseSchedule: "remote-projects-excluded",
  resumeSchedule: "remote-projects-excluded",
  ...
  dbInsertThreadNativeSession: "remote-runtime-mirror-local",
  dbListThreadNativeSessions: "remote-runtime-mirror-local",
  ...
  appendUsageEvents: "device-owned-usage-ledger",
