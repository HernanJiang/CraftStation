...
// `.craftstation-thinking-text` shimmer ("Working for"/"Thinking"/"Compacting"/
// "Proposed plan") and the `.craftstation-brain-thinking` firing.
//
...
// @keyframes craftstation-brain-firing: 0%/100% = 0.45, 50% = 1).
...
/**
 * Register a `.craftstation-thinking-text` element to receive the shimmer sweep
...
/**
 * Register a `.craftstation-brain-thinking` SVG to receive the staggered per-path
