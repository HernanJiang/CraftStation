...
export interface ContextMenuProps {
  ...
  /** Optional imperative open request for an in-row overflow button. */
...
export function ContextMenu(props: ContextMenuProps) {
  const { items, onAction, children, openRequest } = props;
  ...
  useEffect(() => {
    ...
    closeAllMenus();
    setPosition({ x: openRequest.x, y: openRequest.y });
