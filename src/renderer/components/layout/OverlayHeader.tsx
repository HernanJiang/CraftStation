 ...
 * `craftstation-overlay-header__controls`.
 */
export function OverlayHeader(props: {
  ...
  return (
    <div
      className="craftstation-overlay-header flex shrink-0 items-center gap-3 bg-[var(--content-background)] px-2"
    ...
    >
      ...
      {onTitleClick ? (
        <button
          type="button"
          className="craftstation-overlay-header__controls text-xs font-semibold leading-none uppercase tracking-[0.12em] text-muted hover:text-foreground transition-colors"
