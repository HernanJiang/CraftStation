...
// `.craftstation-provider-icon__mask-scan::before` pseudo-element (see styles.css).
...
const MASK_SCAN_ANIMATION_NAME = "craftstation-provider-icon-mask-scan";

/**
 * Ref callback for the `.craftstation-provider-icon__mask-scan` span. Snaps the
