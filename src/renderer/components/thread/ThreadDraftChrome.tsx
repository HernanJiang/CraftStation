  ...
  return (
    ...
    >
      <div
        ...
        className={`${props.dragHandleRef ? "craftstation-content-over-drag-region cursor-grab active:cursor-grabbing" : "craftstation-content-over-drag-region--drag"} ${props.alignClass} flex w-full max-w-[920px] items-center gap-2 py-1`}
      >
