...
export function InlineFolderPathChip({
  ...
  const chipInner = (
    <>
      ...
      <span className="craftstation-inline-path-chip__name">{path}</span>
    </>
  );
  ...
  if (actions.length === 0) {
    return (
      <span className="craftstation-inline-path-chip" title={path}>
        {chipInner}
      </span>
    );
  }
  ...
  if (mobile) {
    ...
    if (actions.length === 1) {
      return (
        <button
          type="button"
          className="craftstation-inline-path-chip"
          title={path}
  ...
  return (
    <Dropdown>
      <button type="button" className="craftstation-inline-path-chip" title={path}>
        {chipInner}
      </button>
