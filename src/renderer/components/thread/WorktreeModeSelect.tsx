...
export function WorktreeModeSelect(props: {
  ...
  const triggerClassName = `craftstation-composer-menu min-w-0 max-w-56 ${
    props.compact ? "craftstation-composer-menu--compact px-2" : "px-2.5"
  }`;
