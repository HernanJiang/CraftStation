...
/** Codex layout: the "+" add menu leads the toolbar (far left). */
function DraftComposerAddControl(props: {
  ...
  return (
    <>
      <ThreadComposer
        ...
        placeholder={props.placeholder ?? t`Ask anything`}
        prompt={prompt}
        submitDisabled={
          authRequired ||
          agentUpdating ||
