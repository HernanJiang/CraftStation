  ...
  return {
    ...
    bridge: {
      ...
      gitAddWorktree: vi.fn<() => Promise<{ path: string }>>().mockResolvedValue({
        path: "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-x",
      }),
...
describe("App", () => {
  ...
  it("uses the resolved worktree path returned by the supervisor when starting from a draft", async () => {
    ...
    expect(bridge.gitWatchWorktrees).toHaveBeenCalledWith({
      projectId: "project-1",
      worktreePaths: ["C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-x"],
    });
  ...
  it("keeps existing thread worktrees watched when creating another worktree", async () => {
      ...
      threads: [
        {
          ...
          attention: "none",
          canResumeWithConfig: false,
          worktreePath: "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-y",
    ...
    await waitFor(() => {
      expect(bridge.gitWatchWorktrees).toHaveBeenCalledWith({
        ...
        worktreePaths: [
          "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-x",
          "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-y",
        ],
      });
    });
  });
  ...
  it("reactively updates watched worktrees when a hidden worktree panel opens and closes", async () => {
    ...
    const visiblePath = "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-y";
    const hiddenPath = "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-z";
  ...
  it("uses a sibling thread branch when merge and remove is triggered from a worktree thread without branch metadata", async () => {
      ...
      threads: [
        {
          ...
          attention: "none",
          canResumeWithConfig: false,
          worktreePath: "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-x",
          archived: false,
          done: false,
          starred: false,
          createdAt: "2026-03-22T00:00:00.000Z",
        ...
        },
        {
          ...
          canResumeWithConfig: false,
          worktreePath: "C:\\Users\\demo\\.craftstation\\worktrees\\repo-12345678\\feature-x",
          worktreeBranch: "craftstation/brave-heron",
          archived: false,
          done: false,
          starred: false,
          createdAt: "2026-03-22T00:00:00.000Z",
    ...
    await waitFor(() => {
      expect(bridge.gitGetWorktreeSourceBranch).toHaveBeenCalledWith({
        projectLocation: { kind: "windows", path: "C:\\repo" },
        branch: "craftstation/brave-heron",
      });
    });
