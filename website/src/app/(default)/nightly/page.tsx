...
export const metadata: Metadata = createPageMetadata({
  title: "CraftStation Nightly — Latest pre-release builds",
  description:
    "Download the latest CraftStation nightly build. Pre-release installers with the newest changes, refreshed automatically from CI.",
  path: "/nightly",
});
